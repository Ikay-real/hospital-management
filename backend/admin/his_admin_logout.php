...
<head>
        <meta charset="utf-8" />
        <title>Plus Medical Sytem</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Facilitating Your Optimal Function." name="description" />
        <meta content="Coderthemes" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/logo_site_nav.png">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span><img src="assets/images/logo_site_nav.png" alt="" height="50"></span>
                                    </a>
                                </div>
