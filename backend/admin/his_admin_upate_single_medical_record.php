...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_mdr']))
		{
			...
			$query="UPDATE  his_medical_records SET  mdr_pat_adr = ?, mdr_pat_age = ?,  mdr_pat_prescr = ?, mdr_pat_diagnosis = ? WHERE mdr_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssss',  $mdr_pat_adr, $mdr_pat_age, $mdr_pat_prescr, $mdr_pat_diagnosis, $mdr_number);
			$stmt->execute();
			/*
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Physio Records</a></li>
                                                <li class="breadcrumb-item active">Manage Physio Record</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Update Physio Record</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text"  name="mdr_pat_ailment" value="<?php echo $row->mdr_pat_diagnosis;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Ailment">
                                                    </div>
                                                </div>
                                                ...
                                                <button type="submit" name="update_patient_mdr" class="ladda-button btn btn-warning" data-style="expand-right">Update Patient Physio Record</button>
