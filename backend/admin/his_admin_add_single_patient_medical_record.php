	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_mdr']))
		{
            ...
            $mdr_number = $_POST['mdr_number'];
             $mdr_pat_diagnosis = $_POST['mdr_pat_diagnosis'];
			...
			$query="INSERT INTO  his_medical_records  (mdr_pat_name, mdr_pat_number, mdr_pat_adr, mdr_pat_age, mdr_number, mdr_pat_prescr, mdr_pat_diagnosis) VALUES(?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $mdr_pat_name, $mdr_pat_number, $mdr_pat_adr, $mdr_pat_age, $mdr_number, $mdr_pat_prescr, $mdr_pat_diagnosis);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Patient Physio Record Addded";
			}
			else {
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Phsyio Records</a></li>
                                                <li class="breadcrumb-item active">Add Physio Record</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Add Physio Record</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text" readonly name="mdr_pat_diagnosis" value="<?php echo $row->pat_diagnosis;?>" class="form-control"  id="inputPassword4" placeholder="Patient Ailment">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Physio Record Number</label>
                                                ...
                                                <button type="submit" name="add_patient_mdr" class="ladda-button btn btn-primary" data-style="expand-right">Add Physio Record</button>
