                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group col-md-6">
                                                    <label for="inputCity" class="col-form-label">Patient's Number</label>
                                                    <input required="required" type="text" value="<?php echo $row->pat_number;?>" name="pat_number" class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-6">
