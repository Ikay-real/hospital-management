...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$query="INSERT INTO his_docs (doc_fname, doc_lname, doc_nId, doc_number, doc_email, doc_pwd) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $doc_fname, $doc_lname,$doc_nId, $doc_number, $doc_email, $doc_pwd);
			$stmt->execute();
			/*
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                ...
                                                <label for="inputAddress" class="col-form-label">National ID</label>
                                                <input required="required" type="National Id" class="form-control" name="doc_nId" id="inputAddress">
                                            </div>
