...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['transfer_patient']))
		{
            ...
            $t_reason=$_POST['t_reason'];
            $t_status=$_POST['t_status'];
            
            
            //sql to insert captured values
			$query="INSERT INTO  his_patient_transfers (t_pat_number, t_pat_name, t_date, t_hospital, t_reason, t_status) VALUES(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $t_pat_number, $t_pat_name, $t_date, $t_hospital, $t_reason, $t_status);
			$stmt->execute();
			
			/*Use Sweet Alerts Instead Of This  Javascript Alerts
			echo"<script>alert('The Patient has been Transferred');</script>";
			*/
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Refferal Hospital & Therapist</label>
                                                    <input type="text" required="required"  name="t_hospital" class="form-control" id="inputEmail4" placeholder="Refferal Hospital & Therapist">
                                                </div>

                                                 <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Reason For Refferal</label>
                                                    <input type="text" required="required"  name="t_reason" class="form-control" id="inputEmail4" placeholder="Reason For Refferal">
                                                </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group" style="display:none">
                                                ...
                                                <input required="required" type="text" value="Transferred" class="form-control" name="t_status" id="inputAddress" placeholder="Patient's Addresss">
                                            </div>
