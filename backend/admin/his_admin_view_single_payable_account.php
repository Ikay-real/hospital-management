                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item active">View Incomes</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3"> Date:  <?php echo $row->acc_number;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger"> Source : <?php echo $row->acc_name;?></h6>
                                                    <hr>
                                                    <h4 class="text-danger">Income Amount : $ <?php echo $row->acc_amount;?> </h6>
                                                    <hr>
                                                    <h4 class="align-centre">Income Description</h6>
                                                    <hr>
