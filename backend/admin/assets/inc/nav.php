        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    ...
                    <img src="assets/images/logo_site_nav.png" alt="" height="50">
                ...
                <span class="logo-sm">
                    ...
                    <img src="assets/images/logo_site_nav.png" alt="" height="100">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_admin_patient_lab_vitals.php" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="his_admin_add_acc.payable.php" class="dropdown-item">
                        <i class="fas fa-coins mr-1"></i>
                        <span>Income</span>
                    </a>

                    <a href="his_admin_add_acc_receivable.php" class="dropdown-item">
