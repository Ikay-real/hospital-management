<?php
  ...
  if(isset($_GET['delete_mdr_number']))
  {
        ...
        $stmt->close();	 
          ...
          if($stmt)
          {
            $success = "Physio Records Deleted";
          }
            else
            {
                $err = "Try Again Later";
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Physio Records</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">View Physio Records</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->mdr_pat_diagnosis;?></td>
