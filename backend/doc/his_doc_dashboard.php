                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Plus Medical System User Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
$pat_diagnosis = 13; // Replace with the desired row ID

// Retrieve the most inserted data from the specified row
$result = mysqli_query($mysqli,"SELECT * FROM his_patients WHERE pat_diagnosis = $pat_diagnosis");
...
?>
                                                ...
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup"><?php echo $key . ": " . $value . "<br>";?></span></h3>
                                        ...
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_view_single_pres.php?pres_number=<?php echo $row->pres_number;?>&&pres_id=<?php echo $row->pres_id;?>" class="badge badge-success"><i class="fas fa-eye"></i> View </a></td>                                                                                                         
                                                </tr>
