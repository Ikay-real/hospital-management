                                ...
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Age :</strong> <span class="ml-2"><?php echo $row->pat_age;?> Years</span></p>
                                         <p class="text-muted mb-2 font-13"><strong>Gender :</strong> <span class="ml-2"><?php echo $row->pat_gen;?> </span></p>
                                          <p class="text-muted mb-2 font-13"><strong>Status :</strong> <span class="ml-2"><?php echo $row->pat_status;?> </span></p>
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Patient Type :</strong> <span class="ml-2"><?php echo $row->pat_type;?> </span></p>
                                          <p class="text-muted mb-2 font-13"><strong>Service Type :</strong> <span class="ml-2"><?php echo $row->pat_service;?> </span></p>
                                          <p class="text-muted mb-2 font-13"><strong>Condition :</strong> <span class="ml-2"><?php echo $row->pat_diagnosis;?> </span></p>
                                        <p class="text-muted mb-2 font-13"><strong>Occupation :</strong> <span class="ml-2"><?php echo $row->pat_occ;?> </span></p>
                                      
                                        <p class="text-muted mb-2 font-13"><strong>Email:</strong> <span class="ml-2"><?php echo $row->pat_email;?> </span></p>
                                       
                                        <p class="text-muted mb-2 font-13"><strong>Mode of Payment :</strong> <span class="ml-2"><?php echo $row->pat_mop;?> </span></p>
                                         <p class="text-muted mb-2 font-13"><strong>Scheme Number :</strong> <span class="ml-2"><?php echo $row->pat_snum;?> </span></p>

                                        <hr>

                                        <p class="text-muted mb-2 font-13"><strong>Registered Date :</strong> <span class="ml-2"><?php echo date("d/m/Y - h:m", strtotime($mysqlDateTime));?></span></p>

                                        <p class="text-muted mb-2 font-13"><strong>Status :</strong> <span class="ml-2"><?php echo $row->pat_discharge_status;?> </span></p>
                                        <hr>
